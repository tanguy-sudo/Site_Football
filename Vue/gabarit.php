        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
              ...
              <?php if(isset($_SESSION['valideConnexion']) && $_SESSION['valideConnexion'] == true) :?>
                ...
                <?php if($_SESSION['type'] == "entraineur") :?>
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownConvocation">
                      ...
                      <li><a class="dropdown-item" href="convocation/convocationSauvegardees/">Convocations sauvegardées</a></li>
                ...
                <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true"><?= ucfirst($_SESSION['type'])." ".$_SESSION['prenom']." ".$_SESSION['nom']?></a>
